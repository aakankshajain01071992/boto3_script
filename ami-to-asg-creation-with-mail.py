...
htmldoc += "<tr style='background:grey;'><td colspan='2'>Provided Details</td></tr>"
htmldoc += "<tr><td>Instance IP</td><td>{0}</td></tr>".format(instance_ip)
htmldoc += "<tr><td>AMI Name</td><td>{0}</td></tr>".format(ami_name)
htmldoc += "<tr><td>AMI Description</td><td>{0}</td></tr>".format(ami_name)
htmldoc += "<tr><td>Launch Configuration Name</td><td>{0}</td></tr>".format(lc_name)
htmldoc += "<tr><td>ASG Name</td><td>{0}</td></tr>".format(asg_name)
